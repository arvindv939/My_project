...
export const ProductCard = ({ product, onPress }: ProductCardProps) => {
  ...
  const handleAddToCart = () => {
    try {
      ...
      Alert.alert("Success", `${product?.name ?? "Product"} added to cart!`)
    } catch (error) {
  ...
  return (
    <TouchableOpacity style={styles.container} onPress={onPress}>
      <View style={styles.imageContainer}>
        <Image
          source={{
            uri: product.image || "https://images.unsplash.com/photo-1542838132-92c53300491e?w=300&h=300&fit=crop",
          }}
          style={styles.image}
          resizeMode="cover"
          defaultSource={{
      ...
      <View style={styles.content}>
        ...
        {product.rating && (
          <View style={styles.ratingContainer}>
            ...
            <Text style={styles.ratingText}>
              {product.rating.average && typeof product.rating.average === "number"
        ...
        <View style={styles.priceContainer}>
          <View style={styles.priceRow}>
            ...
            {product.originalPrice && product.originalPrice > product.price && (
              <Text style={styles.originalPrice}>{formatIndianCurrency(product.originalPrice)}</Text>
            )}
          </View>
        </View>
