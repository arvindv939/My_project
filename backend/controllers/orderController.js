...
exports.createOrder = async (req, res) => {
  try {
    ...
    // If payment is already made, automatically confirm the order
    if (order.paymentStatus === "paid") {
      order.status = "confirmed";
      order.statusHistory.push({
        status: "confirmed",
        timestamp: new Date(),
        note: "Payment received - Order confirmed automatically",
      });
      await order.save();
    }
    ...
    exports.updatePaymentMethod = async (req, res) => {
      try {
        ...
        if (paymentStatus) {
          ...
          // 🚀 AUTOMATIC STATUS PROGRESSION: Payment received → Confirmed
